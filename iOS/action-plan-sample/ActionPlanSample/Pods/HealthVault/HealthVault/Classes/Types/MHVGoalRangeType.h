...
@interface MHVGoalRangeType : MHVType

@property (readwrite, nonatomic, strong) MHVCodableValue *name;
@property (readwrite, nonatomic, strong) NSString *descriptionText;
@property (readwrite, nonatomic, strong) MHVGeneralMeasurement *minimum;
@property (readwrite, nonatomic, strong) MHVGeneralMeasurement *maximum;
